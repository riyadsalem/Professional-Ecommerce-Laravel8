...
class CategoryController extends Controller
{
    ...
    public function CategoryStore(Request $request){
     ...
     public function CategoryEdit($id){
        $category = Category::findOrFail($id); // findOrFail >> لو ما في نتيجة رجعت حيأدي لخطأ 
    ...
    public function CategoryUpdate(Request $request){
        ...
        Category::findOrFail($category_id)->update([
            'category_name_en' => $request->category_name_en,
            'category_name_ar' => $request->category_name_ar,
            'category_slug_en' => strtolower(str_replace(' ','-',$request->category_name_en )), // NEW Brand -> new-brane
            'category_slug_ar' => strtolower(str_replace(' ','-',$request->category_name_ar)),
            'category_icon' => $request->category_icon,
        ]);
