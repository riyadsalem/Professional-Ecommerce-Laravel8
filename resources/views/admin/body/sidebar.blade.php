            ...
            <li class="treeview {{ ($prefix == '/brand') ? 'active' : '' }}">
              ...
              <ul class="treeview-menu">
                <li class="{{ ($route == 'all.brand') ? 'active' : '' }}">
                  <a href="{{ route('all.brand') }}"><i class="ti-more"></i>All Branad</a>
                </li>
              </ul>
            </li>
            @else
            ...
            <li class="treeview {{ $prefix == '/category' ? 'active' : '' }} ">
              ...
              <ul class="treeview-menu">
                ...
                <li class="{{ $route == 'all.subsubcategory' ? 'active' : '' }} ">
                  <a href="{{ route('all.subsubcategory') }}"><i class="ti-more"></i>All SubSubCategory</a>
                </li>
              </ul>
            </li>
            @else
            ...
            <li class="treeview {{ ($prefix == '/shipping') ? 'active' : '' }} " >
              ...
              <ul class="treeview-menu">
                ...
                <li class="{{ $route == 'manage-division' ? 'active' : '' }} ">
                  <a href=" {{ route('manage-division') }}"><i class="ti-more"></i>Shipp Division</a>
                </li>

                <li class="{{ $route == 'manage-District' ? 'active' : '' }} ">
                  <a href=" {{ route('manage-District') }}"><i class="ti-more"></i>Shipp District</a>
                </li>

                <li class="{{ $route == 'manage-State' ? 'active' : '' }} ">
                  <a href=" {{ route('manage-State') }}"><i class="ti-more"></i>Shipp State</a>
                </li>
            ...
            <li class="treeview {{ ($prefix == '/reports') ? 'active' : '' }} " >
              ...
              <ul class="treeview-menu">
                ...
                <li class="{{ $route == 'all-reports' ? 'active' : '' }} ">
                  <a href=" {{ route('all-reports') }}"><i class="ti-more"></i>Search Reports</a>
                </li>
