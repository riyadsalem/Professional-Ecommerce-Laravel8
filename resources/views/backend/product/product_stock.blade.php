              ...
              <div class="col-12">
                <div class="box">
                  <div class="box-header with-border">
                    <h3 class="box-title">Products Stock List <span class="badge badge-pill badge-danger"> {{ count($products) }} </span> </h3>
                  </div>
                  <!-- /.box-header -->
                  <div class="box-body">
                        ...
                        <tbody>
                          ...
                          <td><img src=" {{ asset($item -> product_thambnail) }} " alt="" style="width:60px; height:50px"></td>
                            ...
                            <td width="30%">
                                ...
                                <a href="{{ route('product.delete',$item->id) }}" class="btn btn-danger" id="" title="Delete Data"><i class="fa fa-trash"></i></a>
