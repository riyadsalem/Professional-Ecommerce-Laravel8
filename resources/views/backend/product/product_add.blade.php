              ...
              <div class="box-body">
                <div class="row">
                  <div class="col">
                    ...
                    <div class="row"><!-- Start 3RD row -->
                         ...
                         <div class="form-group">
                            ...
                            <div class="controls">
                            <input type="text" name="product_tags_en" value="Apple,HD" data-role="tagsinput" required="" />
                    ...
                    <div class="row"><!-- Start 4TH row -->
                            ...
                            <div class="controls">
                            <input type="text" name="product_tags_ar" value="ابل,HD" data-role="tagsinput" required="" />
                            ...
                            <div class="controls">
                            <input type="text" name="product_size_en" value="Small,Larg" data-role="tagsinput" />
                            ...
                            <div class="controls">
                            <input type="text" name="product_size_ar" value="صغير,كبير" data-role="tagsinput"  />
                    ...
                    <div class="row"><!-- Start 5TH row -->
                            ...
                            <div class="controls">
                            <input type="text" name="product_color_en" value="Red,Black" data-role="tagsinput"  />
                            ...
                            <div class="controls">
                            <input type="text" name="product_color_ar" value="أحمر,أسود" data-role="tagsinput"  />
                 ...
                 <hr>
                    ...
                    <div class="form-group">
                    <h5>
                      Digital Product <span class="text-danger">jpeg,png,jpg,zip,pdf,xlx,csv</span>
                    </h5>
                    <div class="controls">
