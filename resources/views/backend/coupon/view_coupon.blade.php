                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td width="25%">
                                ...
                                <a href="{{ route('coupon.delete',$item->id) }}" class="btn btn-danger " id="" title="Delete Data"><i class="fa fa-trash"></i></a>
              ...
              <div class="col-4">
               ...
               @csrf 
                   ...
                   <div class="form-group">
                       ...
                       <div class="controls">
                           <input type="number" name="coupon_discount" class="form-control" min="1" >
