                      ...
                      >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td width="20%">
                                <a href="{{ route('blog.post.edit',$item->id) }}" class="btn btn-info" title="Edit Blog Post"><i class="fa fa-pencil"></i></a>
                                <a href="{{ route('blog.post.delete',$item->id) }}" class="btn btn-danger" id="" title="Delete Blog Post"><i class="fa fa-trash"></i></a>
