                ...
                <div class="row">
                  <div class="col">
                    ...
                    <div class="row"><!-- Start 2EN row -->
                         ...
                         <div class="form-group">
                            ...
                            <div class="controls">
                              <input type="text" name="post_title_ar" class="form-control" required="" value="{{ $blogpost->post_title_ar }}" />
                    ...
                    <div class="row"><!-- Start 6TH row -->
                            ...
                            <input type="file" name="post_image" class="form-control" onChange="mainThamUrl(this)" required="" />
                              ...
                              <img src="{{ asset($blogpost->post_image) }}" alt="" id="mainThmb" width="200px" height="100px"> 
                 ...
                 <hr>
                     ...
                     <div class="text-xs-right">
                      <Input type="submit" class="btn btn-rounded btn-info" value="Update Post ">
                      </div>
