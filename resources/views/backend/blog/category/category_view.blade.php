                      ...
                      >
                        ...
                        <tbody>
                          ...
                          <tr>
                            ...
                            <td>
                                <a href="{{ route('blog.category.edit',$item->id) }}" class="btn btn-info" title="Edit Blog Category"><i class="fa fa-pencil"></i></a>
                                <a href="{{ route('blog.category.delete',$item->id) }}" class="btn btn-danger" id="" title="Delete Blog Category"><i class="fa fa-trash"></i></a>
