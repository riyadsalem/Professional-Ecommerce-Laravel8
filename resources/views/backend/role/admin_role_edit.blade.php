             ...
             <div class="row">
               ...
               <div class="row">
                   ...
                   <div class="form-group">
                       ...
                       <div class="controls">
                           <input type="file" name="profile_photo_path" class="form-control" require="" id="image"></div>
                   </div>
                   </div> <!-- end col-md-6 -->
               ...
               <div class="text-xs-right">
                   <Input type="submit" class="btn btn-rounded btn-info" value="Update Admin User">
               </div>
           </form>
