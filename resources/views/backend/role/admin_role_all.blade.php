                        ...
                        <tbody>
                          ...
                          <td> <img src="{{ asset($item->profile_photo_path) }}" style="width:50px; height:50px">  </td>
                            ...
                            <td>
                              ...
                              @if($item->alluser == 1)
                              <span class="badge btn-warning" >AllUser</span>
                              @else
                              @endif
                            ...
                            <td width="25%">
                                <a target="_blanck" href="{{ route('edit.admin.user',$item->id) }}" class="btn btn-info " title="Edit Data"><i class="fa fa-pencil"></i></a>

                                <a href="{{ route('delete.admin.user',$item->id) }}" class="btn btn-danger " id="" title="Delete"><i class="fa fa-trash"></i></a>
