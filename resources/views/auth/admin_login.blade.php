...
<head>
  <meta charset="utf-8">
    ...
    <title>Esay Ecommerce Admin - Log in </title>
			...
			<div class="col-12">
				<div class="row justify-content-center no-gutters">
					<div class="col-lg-4 col-md-5 col-12">
					 ...
					 <!-- ببساطة الان لازم اقول اله انو ال login لمين ولذلك انا مرت ال guard معي على الصفحة  -->
                     <form method="POST" action="{{ isset($guard) ? url($guard.'/login') : ('login') }}">
                      @csrf
