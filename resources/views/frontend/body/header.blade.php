      ...
      <div class="header-top-inner">
        <div class="cnt-account">
          <ul class="list-unstyled">
            ...
            @if(session()->get('language') == 'arabic')  المفضلة @else Wishlist @endif
            </a></li>
            <li><a href="{{ route('mycart') }}"><i class="icon fa fa-shopping-cart"></i>My Cart</a></li>
            <li><a href="{{ route('checkout') }}"><i class="icon fa fa-shopping-cart"></i>Checkout</a></li>
            <li><a href="" type="button" data-toggle="modal" data-target="#ordertraking"><i class="icon fa fa-shopping-cart"></i>Order Traking</a></li>
            ...
            @auth 
            <a href="{{url('dashboard')}}"><i class="icon fa fa-lock"></i>User Profile</a>
            @else
        ...
        <div class="cnt-block">
          <ul class="list-unstyled list-inline">
            ...
            <li class="dropdown dropdown-small"> <a href="#" class="dropdown-toggle" data-hover="dropdown" data-toggle="dropdown"><span class="value">
              ...
              @if(session()->get('language') == 'arabic')  الغة @else Language @endif
    ...
    <div class="container">
      <div class="row">
        <div class="col-xs-12 col-sm-12 col-md-3 logo-holder"> 
          ...
          @php 
          $logo = App\Models\SiteSetting::find(1)->logo;
          @endphp


          <div class="logo"> <a href="{{url('/')}}"> <img src="{{asset($logo)}}" alt="logo"> </a> </div>
          <!-- /.logo --> 
          <!-- ==================================== LOGO : END ================================================= --> </div>
        <!-- /.logo-holder -->
          ...
          <div class="search-area">
            <form method="post" action="{{route('product.search')}}">
              ...
              <div class="control-group">
                ...
                <input class="search-field" name="search" id="search" placeholder="Search here..." onfocus="search_result_show()" onblur="search_result_hide()" />
