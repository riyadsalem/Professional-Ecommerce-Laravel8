	...
	<div class="container">
		<div class="breadcrumb-inner">
			<ul class="list-inline list-unstyled">
                ...
                @php
                $categoryName = App\Models\Category::findOrFail($product -> category_id);
                @endphp

				<li><a href="#">{{ $categoryName -> category_name_en }}</a></li>
...
<div class="sidebar-widget  wow fadeInUp outer-top-vs ">
	<div id="advertisement" class="advertisement">
		...
		<div class="clients_author">John Do<span>Abc Company</span>	</div><!-- /.container-fluid -->
        </div><!-- /.item -->
...
@endphp
              ...
              <!-- /////////////////////// Add Product Color And Size: Start /////////////////////// -->
			<div class="row">
						...
						<div class="col-sm-6">
						 ...
						 @else
							 ...
							 @if(session()->get('language') == 'arabic')
								<option selected="" disabled="" >--أختار الون--</option>
						...
						<div class="col-sm-6">
						 ...
						 <div class="form-group">
							 ...
							 @if(session()->get('language') == 'arabic')
								<option selected="" disabled="" >--أختار المقاس--</option>
              ...
              <!-- /////////////////////// Add Product Color And Size: End /////////////////////// -->
                ...
                <div class="addthis_inline_share_toolbox_88hg"></div>
									...
									<div class="product-tab">
										...
										<div class="product-reviews">
											...
											<div class="review">
											    ...
											    <div class="row">
													<div class="col-md-12"
														<img src="{{ (!empty($item->user->profile_photo_path)) ?  url('upload/user_images/'.$item->user->profile_photo_path) : url('upload/no_image.jpg') }}" alt="" width="40px" height="40px" style="border-radius: 50%; margin-right:10px"> <b>{{ $item->user->name}} </b> | <a href="mailto:{{$item->user->email }}" class="badge" style="padding:7px;"><i class="fa fa-envelope-o fa-fw"></i> {{ $item->user->email }}</a>

														@if($item->rating == NULL)
														
														@elseif($item->rating == 1)									<span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star"></span>
                                                        <span class="fa fa-star"></span>
                                                        <span class="fa fa-star"></span>
                                                        <span class="fa fa-star"></span>

														@elseif($item->rating == 2)									<span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star"></span>
                                                        <span class="fa fa-star"></span>
                                                        <span class="fa fa-star"></span>

														@elseif($item->rating == 3)									<span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star"></span>
                                                        <span class="fa fa-star"></span>

														@elseif($item->rating == 4)									<span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star"></span>

														@elseif($item->rating == 5)									<span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star checked"></span>
                                                        <span class="fa fa-star checked"></span>
													...
													<div class="review-title"><span class="summary">{{ $item->summary }}</span><span class="date"><i class="fa fa-calendar"></i><span></span>{{ Carbon\Carbon::parse($item->created_at)->diffForHumans() }}</span></div>
	...
	<!-- ===================== RELATED PRODUCTS: Start >> query by category_id =============================== -->
...
<!-- Go to www.addthis.com/dashboard to customize your tools -->
<script type="text/javascript" src="//s7.addthis.com/js/300/addthis_widget.js#pubid=ra-6229c3fa357541e0"></script>
