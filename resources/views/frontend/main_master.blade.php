      ...
      <div class="row">
          ...
          <ul class="list-group">
             ...
             <li class="list-group-item">Stock: 
              <span class="badge badge-pill badge-succes" id="available" style="background: green; color: white;"></span> 
          ...
          <button type="submit" class="btn btn-primary mb-2" onclick="addToCart()">Add To Card</button>
                 ...
                 <tr>
                    ...
                    <td class="col-md-7">
                        ...
                        <td class="col-md-1 close-btn">
                            <button class="" type="submit" id="${value.id}" onclick="wishlistRemove(this.id)">
                ...
                $.each(response.carts, function(key,value){
                 ...
                 <tr>
                    ...
                    <strong>$${value.subtotal}</strong>
                        ...
                        <td class="col-md-1 close-btn">
                            <button class="" type="submit" id="${value.rowId}" onclick="cartRemove(this.id)">
                            <i class="fa fa-times"></i>
                            </button>
                        </td>
                 </tr>
