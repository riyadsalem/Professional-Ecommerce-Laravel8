...
<div class="container">
    <article class="card">
        <header class="card-header" style="padding:20px"> <b> My Orders / Tracking </b> </header>
        <div class="card-body">
        ...
        <div class="row" style="margin-left: 5px ; margin-top: 5px ;">
            ...
            <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Delivered <span class="badge badge-danger">
                @if($track->return_reason == NULL )
                Not Return
                @else
                Return
                @endif
            ...
            <div class="step active"> <span class="icon"> <i class="fa fa-check"></i> </span> <span class="text">Cancel</span> </div>
