...
<!-- 
 ...
 -->              
            ...
            <div class="tab-pane in active" id="all">
              <div class="product-slider">
                ...
                @foreach($products as $product)
                    ...
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                          ...
                          <div>
                            @if($product -> discount_price == NULL)
                            <div class="tag new"><span>0%</span></div>
                            @else
                  ...
                  <!-- /.item -->
                @endforeach <!-- End PRODUCT Option Foreach -->
           ...
           @foreach($categories as $category)             
            <div class="tab-pane" id="category{{ $category -> id }}">
              <div class="product-slider">
                ...
                @php 
                $catewaseProduct = App\models\Product::where([ ['category_id',$category->id],['status',1] ])
                ->orderBy('id','DESC')->get();
                @endphp

                @forelse($catewaseProduct as $product)
                  <div class="item item-carousel">
                    <div class="products">
                      <div class="product">
                        <div class="product-image">
                  ...
                  @empty
                  @if(session()->get('language') == 'arabic')
                  <h5 class="text-danger">لا يوجد منتجات </h5>
                  @else
                  <h5 class="text-danger">No Product Found</h5>
                  @endif


                @endforelse <!-- End PRODUCT Option Foreach -->
        ...
        <!-- ================= FEATURED PRODUCTS : END ============================================== --> 
         ...
         <!-- =============== skip_product_0 PRODUCTS ============================================== -->
          ...
          <h3 class="section-title">
            @if(session()->get('language') == 'arabic')
            التصنيف {{ $skip_category_0 -> category_name_ar }} 
            @else
        ...
        <!-- ================= skip_product_0 PRODUCTS : END ============================================== --> 
         ...
         <!-- =============== skip_product_4 PRODUCTS ============================================== -->
         <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
            @if(session()->get('language') == 'arabic')
            التصنيف {{ $skip_category_4 -> category_name_ar }} 
            @else
            {{ $skip_category_4 -> category_name_en }} Category
            @endif
             </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
        ...
        <!-- /.section --> 
        <!-- ================= skip_product_4 PRODUCTS : END ============================================== --> 




        <!-- =============== skip_brand_5 PRODUCTS ============================================== -->
                 <section class="section featured-product wow fadeInUp">
          <h3 class="section-title">
            @if(session()->get('language') == 'arabic')
            الماركة {{ $skip_brand_5 -> brand_name_ar }}
            @else
            {{ $skip_brand_5 -> brand_name_en }} Brand
            @endif
             </h3>
          <div class="owl-carousel home-owl-carousel custom-carousel owl-theme outer-top-xs">
              ...
              <div class="item">
                <div class="blog-post">
                  ...
                  <div class="blog-post-info text-left">
                    <h3 class="name"><a href="{{ route('post.details',$blog->id) }}">
                      @if(session()->get('language') == 'arabic')
                      {{ $blog -> post_title_ar }}
                      @else
                      {{ $blog -> post_title_en }}
                    ...
                    <span class="info"> {{ Carbon\Carbon::parse($blog->created_at)->diffForhumans() }} from now</span>
                    <p class="text">
                      @if(session()->get('language') == 'arabic')
