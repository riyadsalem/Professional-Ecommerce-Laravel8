	    ...
	    <div class="panel-body">
			<div class="row">		
				...
				<div class="col-md-6 col-sm-6 already-registered-login">
					<h4 class="checkout-subtitle"><b><b>Shipping Address</b></b></h4>
					...
					<form class="register-form" role="form" action="{{ route('checkout.store') }}" method="POST">
                      ...
                      <div class="form-group">
					    ...
					    <input type="eamil" name="shipping_email" class="form-control unicase-form-control text-input" id="exampleInputEmail1" placeholder="Email" value="{{ Auth::user()->email }}"  required="" >
					  </div><!-- form-group -->
				...
				<div class="col-md-6 col-sm-6 already-registered-login">
                         ...
                         <div class="form-group">
                            <h5>
                              State Select <span class="text-danger">*</span>
                            </h5>
                            <div class="controls">
